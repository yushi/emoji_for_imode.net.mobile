...
function createEmojiButton(emoji, dst){
    var img = document.createElement('img');
    if(emojichar2gifnum[emoji] == "   "){
        return null;
    }
    img.src =  imgUrlBase + emojichar2gifnum[emoji] + '.gif';
    img.charCode = emoji;
...
function appendEditor(dst){
    var iframe = document.createElement('iframe');
    iframe.id = "emoji_editor";
...
function showEmojiEditor(textarea){
    var parent = textarea.parentNode;
    appendEditor(parent);

    var form = document.getElementsByTagName('form')[0];
    form.onsubmit = function(){
        var editor = getEmojiEditor();
...
function getEmojiEditor(){
    return document.getElementById('emoji_editor');
}

function getOriginalTextArea(){
    var textarea;
    try{
        textarea = document.getElementsByClassName('text-textarea')[0];
    } catch (e) {}
    return textarea;
}

(function(){
     var textarea = getOriginalTextArea();
     if(textarea){
         textarea.style.display = "none";
         showEmojiEditor(textarea); 
     }
 })();
